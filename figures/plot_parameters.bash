...
psbasemap -JX10 -R0/1/40/70 -Ba0.2f0.1:"x Al":/a5f1:"Cell volume (\305@+3@+)":E  -K -P > ${base}.ps
psbasemap -JX10 -R0/1/2.5/5 -Ba0.2f0.1:"1 - X@-SiO2@-":/a0.5f0.1:"Cell length (\305)":SWn -O -K -P >> ${base}.ps
...
awk 'NR>1 {print $1, ($2*$4*$6)}' volumes.dat | psxy -JX10 -R0/1/40/70 -O -K -N -Sc0.1c -Gblack  >> ${base}.ps
